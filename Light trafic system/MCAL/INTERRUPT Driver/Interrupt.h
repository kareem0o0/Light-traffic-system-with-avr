...
state MINTERRUPT_voidEnableExternalInterrupt(enum INTERRUPT_EXTERNAL_TYPE Interrupt);
state MINTERRUPT_voidDisableExternalInterrupt(enum INTERRUPT_EXTERNAL_TYPE Interrupt);
